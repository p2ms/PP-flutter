...
class HomeWidget extends StatefulWidget {
  const HomeWidget({Key? key, required String title}) : super(key: key);
                  ...
                  Expanded(
                    child: Padding(
                      ...
                      child: GridView(
                        ...
                        children: [
                          IconButton(
                            color: Color.fromARGB(255, 156, 177, 245)  ,
                            //borderRadius: 30,
                            //borderWidth: 1,
                            iconSize: 60,
                            icon: Icon(
                          ...
                          IconButton(
                            color: Color.fromARGB(255, 252, 226, 185),
                            iconSize: 60,
                            icon: Icon(
                              Icons.person,
                              color: Color(0xFFF9A825),
